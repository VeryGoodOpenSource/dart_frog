...
/// Objectives:
///
/// * Generate two new Dart Frog project via `dart_frog create`
/// * Run the devs server via `dart_frog dev`
/// * Ensure the servers are running
void main() {
  group('multiple dart_frog dev', () {
    ...
    test(
      '''running two different dart_frog dev command will fail when different dart vm port is not set''',
      () async {
